...
{#if variant === 'filled'}
  <md-filled-icon-button bind:this={component} {toggle} {selected} {disabled} {href} {target} {type} {value} {name} {...props}>
    {@render children()}
  </md-filled-icon-button>
{:else if variant === 'filled-tonal'}
  <md-filled-tonal-icon-button bind:this={component} {toggle} {selected} {disabled} {href} {target} {type} {value} {name} {...props}>
    {@render children()}
  </md-filled-tonal-icon-button>
{:else if variant === 'outlined'}
  <md-outlined-icon-button bind:this={component} {toggle} {selected} {disabled} {href} {target} {type} {value} {name} {...props}>
    {@render children()}
  </md-outlined-icon-button>
{:else}
  <md-icon-button bind:this={component} {toggle} {selected} {disabled} {href} {target} {type} {value} {name} {...props}>
    {@render children()}
  </md-icon-button>
{/if}
